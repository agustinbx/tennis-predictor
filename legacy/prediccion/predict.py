...
print("[START] INICIANDO OPTIMIZACIÓN AVANZADA DEL MODELO...")
...
# =============================================================================
# 🎛 4. TUNING DE HIPERPARÁMETROS (LA CLAVE)
# =============================================================================
...
# =============================================================================
# [TOP] 5. EVALUACIÓN FINAL
# =============================================================================
preds = best_model.predict(X_test)
acc = accuracy_score(y_test, preds)

print("-" * 40)
print(f"[TARGET] PRECISIÓN MEJORADA: {acc*100:.2f}%")
print("-" * 40)
...
if high_conf_indices:
    ...
    print(f"[OK] Precisión en apuestas de Alta Confianza (>60%): {acc_high*100:.2f}%")
...
print("\n[OK] Archivos guardados con éxito.")