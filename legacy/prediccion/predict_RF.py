...
print("🏟 Iniciando Entrenamiento con FACTOR LOCALÍA...")
# -------------------------------------------------------------------------
# 1. CARGAR PARTIDOS
# -------------------------------------------------------------------------
try:
    ...
    print("[FAIL] Falta el archivo CSV.")
    exit()
...
# -------------------------------------------------------------------------
print("[STATS] Calculando variables...")
...
print("\n" + "="*40)
print(f"[START] PRECISIÓN V3: {acc:.2%}")
print("="*40)
