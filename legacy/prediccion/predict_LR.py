...
print("[TOP] Entrenando y Guardando el Modelo Campeón (Regresión Logística)...")
...
# -------------------------------------------------------------------------
# CÁLCULO DE HEAD-TO-HEAD (H2H) [VS]
# -------------------------------------------------------------------------
print("[VS] Calculando historial entre jugadores (H2H)...")
...
print(f"\n[TARGET] Precisión Final en Test Set: {acc*100:.2f}%")
...
try:
    ...
    print("[STATS] Gráfico guardado como 'matriz_confusion.png'")
except:
    print("⚠ No se pudo generar el gráfico (falta entorno gráfico), pero el modelo se entrenó bien.")

# F. Guardar
joblib.dump(best_model, 'modelo_logistico_final.pkl')
joblib.dump(scaler, 'scaler_final.pkl') 
print("\n[OK] Archivos guardados: modelo_logistico_final.pkl, scaler_final.pkl")