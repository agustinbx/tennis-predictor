...
MODO DE USO:
    python prediccion/predict_xgboost.py              # Pipeline básico
    python prediccion/predict_xgboost.py --advanced   # Pipeline con CV, GridSearch y Calibración
    python prediccion/predict_xgboost.py --no-grid   # CV + Calibración sin GridSearch
"""
import sys
import argparse
